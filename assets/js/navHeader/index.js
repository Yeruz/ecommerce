const logo = (paths) => {
  const logoLink = `
  <a href="${paths.home}">
      <img src="${paths.controle}" alt="imagen de un controlador de videojuego">
...
export function nav(paths) {
  ...
  <div class="navHeader__left">
    ...
    <div class="navHeader__search">
      ...
      <img src="${
        paths.lupa
      }" alt="imagen de una lupa, para buscar" class="navHeader__search--img">
    </div>
  </div>
  ${
    paths.login &&
    `<div class="navHeader__login"><a href="${paths.login}" class="btn__login">Login</a><img class="lupa__hidden" src="${paths.lupa}" alt="imagen de una lupa" data-input/></div><input type="text" class="lupa__hidden--input" placeholder="¿Qué buscas?"/>`
  }
  `;
  ...
  <section class="footer">
    <div class="container">
      ...
      <div class="footer__text">
        ...
        <a href="#">Programa fidelidad</a href="">
        <a href="#">Nuestras Tiendas</a href="">
        <a href="#">Quiero ser franquiciador</a href="">
